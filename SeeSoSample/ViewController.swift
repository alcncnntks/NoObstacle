...
class ViewController: UIViewController {
    ...
    let licenseKey : String = "dev_f9kav74v4hmayfxe05xwjeogzfpbjqrtbsrmvabj" // Please enter the key value for development issued by the SeeSo.io
    //
    var frame : Int = 0
...
//        initGazeFilterUI()
    ...
    private func initModeUI(){
        ...
        userStatusSwitch.frame.origin = CGPoint(x: self.view.frame.width/2 + 40, y: self.view.frame.height/2 + 40)
    ...
    private func initInitTrackerUI(){
        ...
        initTrackerSwitch.frame.origin = CGPoint(x: self.view.frame.width/2 + 40, y: self.view.frame.height/2 + 100)
    ...
    private func initPreview() {
        preview.frame.size = CGSize(width: 250, height: 250)
        preview.center = CGPoint(x: self.view.frame.width/2 + 50, y: 260)
        preview.alpha = 0.7
    ...
    private func initStartTrackingUI(){
        ...
        startTrackingSwitch.frame.origin = CGPoint(x: self.view.frame.width/2 + 40, y: self.view.frame.height/2 + 160)
    ...
    private func initGazeFilterUI(){
        ...
        gazeFilterSwitch.frame.origin = CGPoint(x: self.view.frame.width/2 + 40, y: self.view.frame.height/2 + 160)
    ...
    private func initStartCalibrationUI(){
        ...
        calibrationBtn.frame.origin = CGPoint(x: self.view.frame.width/2 + 30, y: self.view.frame.height/2 + 280)
    ...
    private func initCalibrationModeUI(){
        ...
        oneRadioBtn.frame.origin = CGPoint(x: self.view.frame.width/2 - 90, y: self.view.frame.height/2 + 280)
        ...
        fiveRadioBtn.frame.origin = CGPoint(x: self.view.frame.width/2 - 30, y: self.view.frame.height/2 + 280)
        ...
        startCalibrationLabel.frame.origin = CGPoint(x:  self.view.frame.width/2 - 80, y: self.view.frame.height/2 + 220)
        ...
        loadBtn.frame = CGRect(x: 0, y: 5, width: bottomView.frame.width, height: bottomView.frame.height/2 - 20)
        ...
        loadBtn.setTitle("Save Calibration", for: .normal)
